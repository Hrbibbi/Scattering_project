...
#                                   Imports
#-----------------------------------------------------------------------------
if True: # set to if statement to help readability
...
#-----------------------------------------------------------------------------
# Subfunctions for constructing the MAS system
#-----------------------------------------------------------------------------
def construct_RHSs(Surface: SP.C2_surface, 
                   propagation_vectors: np.ndarray,
    ...
    #---------------------------------------------------------
    # Possible change to make rhs_matrix better chache aligned
    #---------------------------------------------------------
    rhs_matrix=b.T # Transpose it to get the desired (4*N, R) matrix
    #rhs_matrix = np.asfortranarray(b.T)
...
# Main MAS functions
#-----------------------------------------------------------------------------
def Construct_solve_MAS_system(Scatter_information, Incident_information,dipoles_per_wl=5,scaling=0.86):
    '''
    ...
    #-------------------------------------------------------------
    Surface,inneraux,outeraux=SPSurface.sample_surface_MAS(lam,dipoles_per_wl=dipoles_per_wl,scaling=scaling)
