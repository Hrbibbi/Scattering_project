...
def sample_surface_MAS(spline_surf,wavelength):
    ...
    inner_points  , tau1_inner, tau2_inner, normals_inner=spline_surf.construct_auxiliary_points(auxiliary_resol, -0.86)
    outer_points  , tau1_outer, tau2_outer, normals_outer=spline_surf.construct_auxiliary_points(auxiliary_resol,  0.86)
    surface_points   , tau1_surf , tau2_surf ,   normals_surf =spline_surf.construct_auxiliary_points(surface_resol  ,  0.00)
