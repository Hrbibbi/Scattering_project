...
class SplineSurface:
    ...
    def sample_surface_MAS(self,wavelength):
        ...
        inner_points  , tau1_inner, tau2_inner, normals_inner=self.construct_auxiliary_points(auxiliary_resol, -0.86)
        outer_points  , tau1_outer, tau2_outer, normals_outer=self.construct_auxiliary_points(auxiliary_resol,  0.86)
